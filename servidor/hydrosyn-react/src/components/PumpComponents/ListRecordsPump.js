...
export default function ListRecordsPump({ systemId, recordPumpList, refresh, userRole, error, setError }) {
    ...
    const columns = [
        ...
        { field: "success", headerName: texts.success, flex: 0.5, minWidth: 100 },
        {
            field: 'created_at',
